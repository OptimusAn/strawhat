...
const (
	Transport_Empty Transport = 0
	Transport_Tcp   Transport = 1
	Transport_Udp   Transport = 3
)
...
type Strawhat struct {
	...
	Transport Transport `protobuf:"varint,2,opt,name=transport,proto3,enum=strawhat.Transport" json:"transport,omitempty"`
}
...
func (x *Strawhat) GetTransport() Transport {
	if x != nil {
		return x.Transport
	}
...
var file_strawhat_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x73, 0x74, 0x72, 0x61, 0x77, 0x68, 0x61, 0x74, 0x22, 0x5b, 0x0a, 0x08, 0x53, 0x74,
	...
	0x63, 0x65, 0x49, 0x44, 0x12, 0x31, 0x0a, 0x09, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72,
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x73, 0x74, 0x72, 0x61, 0x77, 0x68,
	0x61, 0x74, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x52, 0x09, 0x74, 0x72,
	0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72, 0x74, 0x2a, 0x28, 0x0a, 0x09, 0x54, 0x72, 0x61, 0x6e, 0x73,
	0x70, 0x6f, 0x72, 0x74, 0x12, 0x09, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x10, 0x00, 0x12,
	0x07, 0x0a, 0x03, 0x54, 0x63, 0x70, 0x10, 0x01, 0x12, 0x07, 0x0a, 0x03, 0x55, 0x64, 0x70, 0x10,
	0x03, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x2f, 0x73, 0x74, 0x72, 0x61, 0x77, 0x68, 0x61, 0x74, 0x62,
...
var file_strawhat_proto_goTypes = []interface{}{
	(Transport)(0),   // 0: strawhat.Transport
	(*Strawhat)(nil), // 1: strawhat.Strawhat
}
var file_strawhat_proto_depIdxs = []int32{
	0, // 0: strawhat.Strawhat.transport:type_name -> strawhat.Transport
